...
class IsnaCrawler:
    def __init__(self):
        self.base_url = 'https://www.isna.ir'
    ...
    def crawl_pagination(self, number_of_pages, tp_map):
        ...
        for tp in tp_map.keys():
            for i in range(1, number_of_pages + 1):
                ...
                news = html.find_all('div', class_='desc')
    ...
    def crawl_news_detail(self, urls):
        ...
        for url in urls:
            ...
            html = BeautifulSoup(resp, 'html.parser')
            text = html.find('div', {'class': 'item-body content-full-news'})
